...
*/
 ...
 //         WHERE flat_id = '$id'"; 
    ...
    $sql = "INSERT INTO $table_name_applications VALUES('','$rumNum','$studNum', '$mobNum','')";
    mysql_query($sql) or die("Error inserting values \n".mysql_error()); 


  //mysql_query($sql) or die("Error inserting values \n".mysql_error()); 
    //echo "Done inserting student values";
...
?>
      ...
      <div class="jumbotron">
        <p class="lead">Thank you for using the online room allocation. You will receive your reply via sms or email</p>

        <p> <?php echo "Hello"."$mobNum" ?></p>
