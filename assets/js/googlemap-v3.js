...
function initialize2() {
  ...
  var mapOptions = {
   ...
   var contentString = '<div id="content">'+
      '<img src="http://localhost:8095/bootstraplive/docs/fixmykasi/uploadajax/uploads/'+imgname+'" alt="Test"'+
      '<h1 id="firstHeading" class="firstHeading">Subject</h1>'+
        '<p>'+data.subject+'</p>'+
      '<div id="bodyContent">'+
      '<p><b>All Comments are monitored. Be polite, conscise and stick to the topic.</b>' +
      '</p>'+
